...
const iconList = ['Cable TV', 'Internet', 'Wireless', 'Air conditioning', 'Wheelchair access possible', 'Swimming pool',
    'Kitchen', 'Gym', 'Breakfast', 'Hot tub', 'Fireplace', 'Washing Machine', 'Dryer', 'Elevator', '24-hour checkin',
    'Hair Dryer', 'Heating', 'Doorman', 'Smoke detector', 'Carbon Monoxide Detector', 'First aid kit',
    'Fire Extinguisher', 'Essentials', 'Shampoo', 'Hangers', 'Iron', 'Laptop Friendly workspace', 'TV',
    'Sound system', 'Smoking allowed', 'Pets allowed', 'Street parking', 'Free parking', 'Suitable for events',
...
const AmenitiesRendering = ({amenitiesList}: AmenitiesRenderingProps) => {
    ...
    return (
        <Grid container spacing={1}>
            <AmenityIconAndTitle icon={'wifi'} title={'Wifi'}/>
            <AmenityIconAndTitle icon={'location_city'} title={'City Views'}/>
            <AmenityIconAndTitle icon={'yard'} title={'Garden'}/>
            <AmenityIconAndTitle icon={'mode_fan'} title={'Air conditioning'}/>
            <AmenityIconAndTitle icon={'countertops'} title={'Kitchen'}/>
            <AmenityIconAndTitle icon={'pool'} title={'Swimming pool'}/>
            <AmenityIconAndTitle icon={'exercise'} title={'Gym'}/>
            <AmenityIconAndTitle icon={'hot_tub'} title={'Hot tub'}/>
            <AmenityIconAndTitle icon={'local_parking'} title={'Free parking'}/>
            <AmenityIconAndTitle icon={'balcony'} title={'Balcony'}/>
