        ...
        <div>
            ...
            >
                ...
                <DialogContent dividers={scroll === 'paper'}>
                    ...
                    <SwitzerText sx={{fontWeight: 600,fontSize:12,mt:1}} text={'Kitchen'} />
                    <Divider/>
                    <Grid container my={1}>
                    ...
                    <SwitzerText sx={{fontWeight: 600,fontSize:12}} text={'Bathroom'} />
                    <Divider/>
                    <Grid container my={1}>
                    ...
                    <SwitzerText sx={{fontWeight: 600,fontSize:12}} text={'Bedroom'} />
                    <Divider/>
                    <Grid container my={1}>
                        <AmenityIconAndTitle icon={<FontAwesomeIcon icon={faWifi}/>} title={'Wifi'}/>
                        <AmenityIconAndTitle icon={<FontAwesomeIcon icon={faTv}/>} title={'TV'}/>
                    ...
                    <SwitzerText sx={{fontWeight: 600,fontSize:12,mt:1}} text={'Parking and Facilities'} />
                    <Divider/>
                    <Grid container my={1}>
                        <AmenityIconAndTitle icon={<FontAwesomeIcon icon={faWifi}/>} title={'Wifi'}/>
                        <AmenityIconAndTitle icon={<FontAwesomeIcon icon={faTv}/>} title={'TV'}/>
                    ...
                    <SwitzerText sx={{fontWeight: 600,fontSize:12,mt:1}} text={'Lobby'} />
                    <Divider/>
                    <SwitzerText sx={{fontWeight: 600,fontSize:12,mt:1}} text={'Outdoor'} />
                    <Divider/>
                </DialogContent>
                <DialogActions>
                    <Button sx={{textTransform: 'none', color: colors.mainColor, fontWeight: 600, fontSize: 12}} onClick={handleClose}>Close</Button>
                </DialogActions>
            </Dialog>
        </div>
    );
