        ...
        <Paper elevation={3} sx={{px: 2, py: 5, borderRadius: 3}}>
            ...
            <Grid container sx={{position: 'relative'}}>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={1} iconSource={consultationIcon} title={'Free Consultation'}
                                       subtitle={'with a Magnificent Expert'}/>
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={2} iconSource={signIcon} title={'Landlord Signs a'}
                                       subtitle={'Management Agreement'}/>
                    {xs && <XsBeforeElement />}
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={3} iconSource={registerIcon} title={'Magnificent Registers The'}
                                       subtitle={'Property With DTCM'}/>
                    {xs && <XsAfterElement />}
                </Grid>
                {xs ? <FlowXsStartIcon/> : <FlowStartAndEndIcon iconName={'home'}/>}
            </Grid>
            <Grid container sx={{position: 'relative'}} direction={xs ? 'column-reverse' : 'row'}>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={6} iconSource={photoIcon} title={'Photo & Video Shoots'}
                ...
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={4} iconSource={furnitureIcon} title={'Support With'}
                                       subtitle={'Furniture'}/>
                    {xs && <XsBeforeElement />}
                </Grid>
                {!xs && <><Box sx={{
            ...
            <Grid container sx={{position: 'relative'}}>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={7} iconSource={channelsIcon} title={'Property is Marketed on'}
                                       subtitle={'Various Channels'}/>
                    {xs && <XsAfterElement />}
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={8} iconSource={searchIcon} title={'Guest Views Property'}
                                       subtitle={'and Books Online'}/>
                    {xs && <XsBeforeElement />}
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={9} iconSource={verificationIcon} title={'Pre-Arrival Call &'}
            ...
            <Grid container sx={{position: 'relative'}}>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={12} iconSource={agreeIcon} title={'Guest Checks out at'}
                                       subtitle={'the agreed time'}/>
                    {xs && <XsBeforeElement />}
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={11} iconSource={stayIcon} title={'Guest Enjoys His Stay'}
                                       subtitle={'with our Unmatched Service'}/>
                    {xs && <XsAfterElement />}
                </Grid>
                <Grid item xs={12} sm={4} md={4} lg={4} mt={5} position={'relative'}>
                    <RentPlaceFlowItem num={10} iconSource={dealIcon} title={'Security Deposit is Held &'}
                                       subtitle={'Guest is Checked-in Personally'}/>
                    {xs && <XsBeforeElement />}
                </Grid>
                {xs ? <FlowXsEndIcon /> : <FlowStartAndEndIcon iconName={'real_estate_agent'}/>}
                {!xs && <Box sx={{
                    '&::before': {
                        content: `""`,
                        border: `1px dashed ${colors.mainColor}`,
