                    ...
                    <Grid container spacing={5}>
                        <Grid item xs={12} sm={4} lg={4}>
                            <Stack direction={'column'} alignItems={'center'}>
                                ...
                                <Typography variant={'subtitle1'} sx={{fontWeight:600,py:2}}>Best Price Guarantee</Typography>
                                <Typography variant={'body2'} align={'center'}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                    ...
                                    in, obcaecati odio quaerat quisquam rem velit. Ex reprehenderit sequi voluptatum!</Typography>
                            </Stack>
                        </Grid>
                        <Grid item xs={12} sm={4} lg={4}>
                            <Stack direction={'column'} alignItems={'center'}>
                        ...
                        <Grid item xs={12} sm={4} lg={4}>
                            <Stack direction={'column'} alignItems={'center'}>
                                ...
                                <Typography variant={'subtitle1'} sx={{fontWeight:600,py:2}}>Customer Service 24h/7d</Typography>
                                <Typography variant={'body2'} align={'center'}>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                    Ab at consectetur consequatur corporis, cum dolorum et ex illo illum,
                                    in, obcaecati odio quaerat quisquam rem velit. Ex reprehenderit sequi voluptatum!</Typography>
                            </Stack>
