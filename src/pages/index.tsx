...
const HomePage = ({ properties, reviews }: HomePageProps) => {
  ...
  return (
    <>
      <NextSeo
        title="Best Property Management Company in Downtown Dubai | Luxury Rental Holiday Homes - Magnificent."
        description="Magnificent is the best property management company in downtown Dubai. Book apartments and vacation holiday homes rental for your stay in downtown Dubai."
        canonical="https://magnificent.ae/"
        openGraph={{
          locale: "en_US",
          type: "website",
          title:
            "Best Property Management Company in Downtown Dubai | Luxury Rental Holiday Homes - Magnificent.",
          description:
            "Magnificent is the best property management company in downtown Dubai. Book apartments and vacation holiday homes rental for your stay in downtown Dubai.",
